<div class="modal fade" id="modalEditarOperador<?= $operador['id_usuario'] ?>"
        ...
        <div class="modal-content operator-modal">
            <div class="modal-header">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="modal-title mb-0" id="modalEditarOperadorTitulo<?= $operador['id_usuario'] ?>">Editar Operador</h5>
                        <small>Actualiza su perfil de atención</small>
                    </div>
            ...
            <div class="modal-body">
                <form method="POST" action="<?= BASE_URL ?>index.php?ruta=operadores&action=actualizar" class="formEditarOperador">
                    ...
                    <div class="modal-footer-custom">
                        ...
                        <button type="submit" class="btn btn-modal-save"><i class="fa-solid fa-check me-2"></i>Guardar cambios</button>
                    </div>
                </form>
            </div>
        </div>
