        ...
        <div class="row align-items-center">
            <div class="col-lg-9">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 class="mb-1">Asignación de Servicios</h4>
                        <p class="mb-0">Configura los servicios disponibles para este operador.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 text-end d-none d-lg-block"><i class="fa-solid fa-user-gear page-header-decoration"></i></div>
        </div>
    </div>
    <div class="card content-card border-0">
        <div class="card-body p-4">
            <div class="operator-summary mb-4">
                <div class="d-flex align-items-center gap-3">
                    <div class="summary-avatar"><i class="fa-solid fa-user-headset"></i></div>
                    <div>
                        <h5 class="mb-1"><?= htmlspecialchars($operador['nombre_user']) ?></h5>
                        <div class="text-muted small"><span><?= htmlspecialchars($operador['usuario_user']) ?></span><span class="mx-2">•</span><span><?= htmlspecialchars($operador['puesto_user'] ?: 'Sin puesto') ?></span><span class="mx-2">•</span><span>Ventanilla <?= htmlspecialchars($operador['num_ventanilla'] ?: '—') ?></span></div>
                    </div>
                </div><a class="btn btn-back" href="<?= BASE_URL ?>index.php?ruta=operadores"><i class="fa-solid fa-arrow-left me-2"></i>Volver</a>
            </div>

            <div class="services-toolbar mb-4">
                <div>
                    <h5 class="mb-1">Servicios activos</h5><small class="text-muted">Selecciona los servicios que este operador puede atender.</small>
                </div>
                <div class="d-flex gap-2"><button type="button" class="btn btn-outline-teal" id="btnSeleccionarTodo"><i class="fa-solid fa-check-double me-2"></i>Todos</button><button type="button" class="btn btn-outline-secondary" id="btnDeseleccionarTodo"><i class="fa-solid fa-xmark me-2"></i>Ninguno</button></div>
            </div>
